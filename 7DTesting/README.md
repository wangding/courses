...
如果你已经完成上面的《七天软件测试入门》课程的学习，那么恭喜你，你现在应该对手工黑盒测试或者自动化测试有了一个基本的认识，而且对于上手开展测试工作也有一些思路了。你现在可以尝试做一些测试的实习工作或者正式工作，在工作的过程中，加深对所学知识的理解和掌握。如果感觉还需要再进一步深入的学习，可以看一下这个清单：
