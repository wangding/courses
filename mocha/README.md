...
基于 Mocha 的自动化测试框架。王顶老师的软件测试 QQ 学习交流群：301862163，加群时请报上自己的真实姓名，以及正在学习的课程内容。

## <img src="https://raw.githubusercontent.com/wangding/courses/master/images/video.png" height="30">课程视频

- [基于 Mocha 的自动化测试框架（上）](http://edu.51cto.com/course/course_id-7320.html)  
- [基于 Mocha 的自动化测试框架（下）](http://edu.51cto.com/course/course_id-7425.html)  

## <img src="https://raw.githubusercontent.com/wangding/courses/master/images/presentation.png" height="30">幻灯片

- [基于 Mocha 的自动化测试框架（上）](https://github.com/wangding/courses/blob/master/mocha/macha01.pptx)  
- [基于 Mocha 的自动化测试框架（下）](https://github.com/wangding/courses/blob/master/mocha/macha02.pptx)  
...
- [Mocha 示例代码](https://github.com/wangding/seIDE/tree/master/DDT)
